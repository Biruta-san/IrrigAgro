...
export const BASE_ROUTE_PLANTA = `${API_BASE_ROUTE}/Planta`
export const GET_PLANTAS = `${BASE_ROUTE_PLANTA}/getAllPlantas`;
export const POST_PLANTA = `${BASE_ROUTE_PLANTA}/postPlanta`;
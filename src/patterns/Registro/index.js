...
import { createUser } from "../../utils/firebaseSdk";
            ...
            <Flex w='50vw' bg={MENU_BG_COLOR} borderRadius={'20px'} direction={'column'} align={'center'} justify={'center'} p={8}>
                <FormControl>
                    <Flex w='100%' direction={'column'} gap='10px'>
                        ...
                        <Button onClick={handleSubmit} variant={{ base: 'submitButton' }} type="submit" isLoading={loading}>Registrar</Button>
                        <Link href='/' w='100%'>
                            <Button variant={{ base: 'submitButton' }} w={'100%'}>Realizar Login</Button>
                        </Link>
                    </Flex>
                </FormControl>
            </Flex>
